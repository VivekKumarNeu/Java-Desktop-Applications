 ...
 * @author Vivek
 */
public class showsupplieranddrug extends javax.swing.JPanel {

    /**
     * Creates new form showsupplieranddrug
     */
    private JPanel userprocesscontrol;
    DrugInventory druginventory;
    supplierdirectory supplierdirectory;

    public showsupplieranddrug(JPanel userprocesscontrol,DrugInventory druginventory,supplierdirectory supplierdirectory) {
        initComponents();
      ...
      public void populatetable(){
        ...
        for ( int i= rowcount -1 ; i>=0; i--)
         ...
         if(Supplier != null){
            ...
            for(Drugs drug : Supplier.getDrugInventory().getdrugsDir()){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     public void populateProductTable(){
        ...
        model.setRowCount(0);
        supplier supply = (supplier) supplierComboBox.getSelectedItem();
    
        if(supply != null){
        
            for(Drugs drug : supply.getDrugInventory().getdrugsDir()){
